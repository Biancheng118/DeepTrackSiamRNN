...
2. Setup the checkpoint path of your pretrained model. Default is `pretrained/DeepTrackSiamRNN.pth`.
...
1. Setup the sequence path in `tools/demo.py`. Default is `~/data/VOT2018/YourSelectionn`.
...
4. Select your target object and press space/enter, press confirm button, then you can start track your object.
